...
###              Baseline Scenario: No errors or peculiarities              ###
###############################################################################
...
#  Save data sheet for illustrative purposes
#  Note: see Stark and Zinn 2020
# write.xlsx(data_sheet, "baseline_dat_sheet.xlsx")
...
#      Test
# graph_attr(graph_indi[[1]], "Path Number") # 1
...
# Determine graph coordinates
coord <- as.matrix(cbind(c(690, 690, 690, 690, 690, 560, 560, 560, 690, 690, 1000, 820),
                         c(500, 440, 380, 320, 260, 220, 160, 100, 100,  40,  260, 220)))
# Determine filter questions
...
# Plot graph
plot(graph_sample, layout = coord, edge.color = "black", main = "Empirical Sample Graph")



### Save empirical graphs of baseline scenario
save(graph_indi, graph_sample, file = "baseline_empirical_graphs.RData")
...
#   -> IMPLICATION: No path frequencies fall below the benchmark value.
#   -> NEXT STEPS:  If no single path frequencies fall below the benchmark
